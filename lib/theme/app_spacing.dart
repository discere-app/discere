...
class AppSpacing {
  ...
  static const EdgeInsets emptyStatePaddingAll = EdgeInsets.all(
    emptyStatePadding,
  );
  ...
  static const EdgeInsets paddingS16Horizontal = EdgeInsets.symmetric(
    horizontal: s16,
  );
  ...
  static const EdgeInsets paddingS4Horizontal = EdgeInsets.symmetric(
    horizontal: s4,
  );

  /// paddingS12Vertical = EdgeInsets.symmetric(vertical: 12.0)
  static const EdgeInsets paddingS12Vertical = EdgeInsets.symmetric(
    vertical: s12,
  );

  /// paddingS4Vertical = EdgeInsets.symmetric(vertical: 4.0)
  static const EdgeInsets paddingS4Vertical = EdgeInsets.symmetric(
    vertical: s4,
  );
