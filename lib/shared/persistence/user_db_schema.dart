...
/// ordered [upgrade] migrations. Extracted from `DatabaseHelper` (which stays a
/// thin open/close lifecycle manager) so each file has one responsibility.
class UserDbSchema {
  UserDbSchema._();

  static final _log = Logger.forType(UserDbSchema);
  ...
  /// current [version], then repairs any missing tables/columns.
