...
class SearchRepository {
  ...
  late final SearchCommonNameEnricher _commonNames = SearchCommonNameEnricher(
    _commonNameRepository,
  ...
  Future<List<SearchResult>> searchAll(String term) async {
    ...
    final enrichedGroups = await _commonNames.enrichRowGroups([
      referenceRows,
      referenceFallbackRows,
      runtimeCommonNameRows,
      fallbackRows,
    ...
    final workerResponse = await _searchWorker.process(
      SearchWorkerRequest(
        ...
        inatRows: _commonNames.applyLiveINatPreferredNames(enrichedGroups[4]),
