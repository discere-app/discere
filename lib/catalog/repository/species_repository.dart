...
class SpeciesRepository {
  ...
  static const String _selectClause =
      ...
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $speciesAlias.$columnSpeciesId AND cn.language = 'de' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${speciesAlias}_$columnSpeciesCommonNameDe,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $speciesAlias.$columnSpeciesId AND cn.language = 'en' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${speciesAlias}_$columnSpeciesCommonNameEn,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $speciesAlias.$columnSpeciesId AND cn.language = 'fr' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${speciesAlias}_$columnSpeciesCommonNameFr,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $speciesAlias.$columnSpeciesId AND cn.language = 'es' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${speciesAlias}_$columnSpeciesCommonNameEs,
      ...
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $generaAlias.$columnGenusId AND cn.language = 'en' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${generaAlias}_$columnGenusCommonName,
      ...
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $familiesAlias.$columnFamilyId AND cn.language = 'de' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${familiesAlias}_$columnFamilyCommonNameDe,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $familiesAlias.$columnFamilyId AND cn.language = 'en' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${familiesAlias}_$columnFamilyCommonNameEn,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $familiesAlias.$columnFamilyId AND cn.language = 'fr' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${familiesAlias}_$columnFamilyCommonNameFr,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $familiesAlias.$columnFamilyId AND cn.language = 'es' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${familiesAlias}_$columnFamilyCommonNameEs,

      $ordersAlias.$columnOrderId AS ${ordersAlias}_$columnOrderId,
      $ordersAlias.$columnOrderName AS ${ordersAlias}_$columnOrderName,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $ordersAlias.$columnOrderId AND cn.language = 'de' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${ordersAlias}_$columnOrderCommonNameDe,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $ordersAlias.$columnOrderId AND cn.language = 'en' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${ordersAlias}_$columnOrderCommonNameEn,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $ordersAlias.$columnOrderId AND cn.language = 'fr' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${ordersAlias}_$columnOrderCommonNameFr,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $ordersAlias.$columnOrderId AND cn.language = 'es' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${ordersAlias}_$columnOrderCommonNameEs,

      $classesAlias.$columnClassId AS ${classesAlias}_$columnClassId,
      $classesAlias.$columnClassName AS ${classesAlias}_$columnClassName,
      (SELECT cn.name FROM common_names cn WHERE cn.entity_id = $classesAlias.$columnClassId AND cn.language = 'en' AND cn.country IS NULL ORDER BY cn.is_preferred DESC, cn.rank ASC LIMIT 1) AS ${classesAlias}_$columnClassCommonName,
