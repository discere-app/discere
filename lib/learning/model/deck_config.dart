...
/// Per-deck configuration for the spaced repetition algorithm, plus what the
/// deck asks for and how.
///
/// Created automatically with defaults when a deck is first accessed. Stored
/// in the `deck_config` table.
class DeckConfig {
  final String deckId;
