...
void main() {
  group('TaxonRank', () {
    test(
      'rankName and entityType round-trip through fromRankName/fromEntityType',
      () {
    ...
    test(
      'rankName and entityType have the expected reference-DB spellings',
      () {
    ...
    test(
      'fromRankName and fromEntityType return null for unrelated strings',
      () {
    ...
    test(
      'fromSearchEntityType maps taxonomy entity types and rejects species',
      () {
        expect(
    ...
    test('entityKey trims and lowercases the scientific name', () {
      ...
      expect(
        TaxonRank.classRank.entityKey('Actinopterygii'),
